(async function () {
    ...
    try {
        ...
        const response = await fetch(
            "https://nova-labs-code.github.io/ZenPlay/sites.json",
            {
                cache: "no-store"
            }
        );
        ...
        hiddenSites =
            Array.isArray(config.hiddenSites)
                ? config.hiddenSites
                : [];
